...
class InventoryServiceTest {
	...
	public void test_getInventory() {
		...
		assertEquals(mockInventory.get().getQuantity(), inventoryFetched.getQuantity());
	...
	public void test_getInventorys() {
		...
		assertEquals(inventorySaved.getQuantity(), inventoryFetched.getQuantity());
	...
	public void test_createInventory() {
		...
		assertEquals(mockInventory.getQuantity(), inventoryCreated.getQuantity());
	...
	public void test_updateInventory() {
		...
		assertEquals(mockInventory.get().getQuantity(), inventoryUpdated.getQuantity());
		verify(inventoryRepository,atLeast(1)).save(Mockito.any(Inventory.class));
	...
	public void test_deleteInventory() {
		...
		assertEquals(mockInventory.get().getQuantity(), inventoryDeleted.getQuantity());
		verify(inventoryRepository,atLeast(1)).findById(Mockito.anyInt());
